	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-center">
			  ...
			  <li class="nav-item">
		        <a class="nav-link" href="fine_paid.php">Fine Paid</a>
		      </li>
		    </ul>
		</div>
	</nav><br>
	...
	<div class="row">
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No of book return: <?php echo get_author_count();?></p>
					<a class="btn btn-primary" href="Regauthor.php" target="_blank">View Return Books</a>
				</div>
			</div>
		</div>
